        ...
        <div className="bg-white dark:bg-gray-900 shadow-2xl rounded-3xl border border-slate-100 dark:border-slate-800 p-10">
          <Formik<LoginPayload> initialValues={initialValues} validationSchema={LoginSchema} onSubmit={handleSubmit}>
            <Form className="space-y-6">
              ...
              <Link href={ROUTES.AUTH.FORGOT_PASSWORD} className="text-xs mb-4 float-right font-bold text-brand-600 hover:text-brand-700 decoration-brand-200">
                Forgot password?
              </Link>
          ...
          <div className="text-center text-gray-500 font-medium">
            ...
            <Link href={ROUTES.AUTH.SIGNUP} className="text-brand-600 hover:text-brand-700 font-bold underline underline-offset-4 decoration-brand-200 ps-1">
              Sign up
            </Link>
          </div>
        </div>
